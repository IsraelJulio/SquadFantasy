    ...
    <main>
      <section className="hero">
        <div className="hero__content">
          ...
          <h1>Cinco em quadra.<br /><em>Um time imortal.</em></h1>
          <p>Escolha lendas do futsal, contrate seu técnico e comande um quinteto em partidas dinâmicas de dois tempos.</p>
