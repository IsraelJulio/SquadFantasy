...
const labels: Record<MatchSimulationStatus, string> = { not_started: 'Aguardando início', first_half: '1º Tempo', half_time: 'Intervalo', second_half: '2º Tempo', paused: 'Pausado para substituição', finished: 'Fim de jogo' }
