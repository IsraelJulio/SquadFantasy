  ...
  return (
    <section className="penalty-panel" aria-live="polite">
      ...
      {shootout.status === 'in_progress' && participants && <>
        ...
        <div className="penalty-duel"><article><small>COBRADOR</small><strong>{participants.taker.name}</strong><span>Overall {participants.taker.overall} · Stamina {participants.taker.stamina}%</span></article><b>VS</b><article><small>GOLEIRO</small><strong>{participants.goalkeeper.name}</strong><span>Overall {participants.goalkeeper.overall} · Stamina {participants.goalkeeper.stamina}%</span></article></div>
